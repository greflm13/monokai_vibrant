...
hi Conditional ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
hi Constant ctermfg=147 ctermbg=NONE cterm=NONE guifg=#e373ce guibg=NONE gui=NONE
hi Define ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
...
hi Keyword ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
hi Label ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
...
hi Operator ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
hi PreProc ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
hi SpecialKey ctermfg=240 ctermbg=59 cterm=NONE guifg=#5b595c guibg=#191b20 gui=NONE
hi Statement ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
...
hi Tag ctermfg=204 ctermbg=NONE cterm=NONE guifg=#ff3f4f guibg=NONE gui=NONE
